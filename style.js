...
/**
 * 2. AOS ANIMATION INITIALIZATION & RESPONSIVE SCALER
 */
document.addEventListener("DOMContentLoaded", () => {
  // Init AOS with mobile settings adjustment
  ...
  // Init Responsive Scaler
  initResponsiveScaler();
});

/**
 * FEATURE: RESPONSIVE SCALER
 * Logic ini hanya aktif di Laptop (1024px - 1600px).
 */
function initResponsiveScaler() {
  function applyScale() {
    const width = window.innerWidth;

    // Rentang Laptop yang biasanya kena dampak Scale 125% Windows
  ...
  return {
    ...
    publishInvitation() {
      const dataToSave = { ...this.data,
        savedThemeId: this.currentThemeId
      };
...
function previewPage() {
  return {
    ...
    data: {
      groomNick: "Romeo",
      brideNick: "Juliet",
      groomFull: "Romeo Montague, S.T.",
      brideFull: "Juliet Capulet, S.Kom.",
      date: "",
      timeStart: "08:00",
      timeEnd: "11:00",
